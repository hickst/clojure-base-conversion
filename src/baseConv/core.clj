...
(defn -main [& args]
  (let [ from62 (convertFromBase 62)
    ...
    (println "'0111111111111111111111111111111111111111111111111111111111111111' in base 2 is"
             (from2 "0111111111111111111111111111111111111111111111111111111111111111")
             "in base 10")
))
